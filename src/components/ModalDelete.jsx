...
export default function ModalDelete({ isOpen, onClose, endPoint, identitasColoumn }) {
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete <br />
                            <b>{dataDetail[identitasColoumn]}</b>?</h3>
